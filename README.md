...
<p align="center">
Profesional orientada a la calidad del software y la mejora continua 💻  
Con amplia trayectoria administrativa y sólida formación técnica en QA y Python (UTN).  
Me destaco por mi organización, análisis funcional y compromiso con la eficiencia en cada proyecto.
</p>
...
Soy una profesional con más de 15 años de experiencia en gestión administrativa, soporte comercial y optimización de procesos, actualmente enfocada en **Quality Assurance** y **automatización con Python**.  
Combino mi experiencia en control, análisis y atención al detalle con herramientas tecnológicas que garantizan calidad y productividad en entornos digitales.
...
#### 🔹 Testing Funcional y de APIs
Creación y ejecución de casos de prueba, identificación de incidencias, documentación de hallazgos y comunicación efectiva con equipos técnicos y comerciales.

#### 🔹 Automatización y Lógica de Programación
Desarrollo de scripts en **Python** aplicados a pruebas automatizadas y validaciones de datos.

#### 🔹 Herramientas de Gestión y Seguimiento
Uso de **Jira** y **Postman** para control de defectos, validaciones y flujo de trabajo ágil.  
Manejo avanzado de Excel, SAP y Oracle para análisis de información y gestión operativa.
